...
with tab1:
    ...
    edited = st.data_editor(edit_df, use_container_width=True, hide_index=True, num_rows="dynamic",
        ...
        column_config={
            ...
            "amount_invested_eur": st.column_config.TextColumn("Invested"),
            "current_value_eur": st.column_config.TextColumn("Current Value"),
            "exit_value_eur": st.column_config.TextColumn("Exit Value"),
            "annual_rental_eur": st.column_config.TextColumn("Rent/yr"),
            "mortgage_total_eur": st.column_config.TextColumn("Mortgage Total"),
            "mortgage_outstanding_eur": st.column_config.TextColumn("Mortgage Out."),
