    ...
    for idx, b in enumerate(items):
        ...
        if inc_rows:
            ...
            edited_inc = st.data_editor(
                ...
                column_config={
                    "Actual Income (EUR)": st.column_config.NumberColumn(format="%.0f"),
                    "Expected (EUR)": st.column_config.NumberColumn(format="%.0f"),
                },
...
with tab3:
    ...
    edited = st.data_editor(edit_df, use_container_width=True, hide_index=True, num_rows="dynamic",
        column_config={
            ...
            "initial_investment_eur": st.column_config.NumberColumn(format="%.0f"),
