...
def shares_editor(tab_key: str, share_list: list, price_key: str, price_val: float):
    ...
    edited = utils.process_math_in_df(edited, ["shares_added", "invested_amount"])
...
with tab3:
    ...
    edited_divs = utils.process_math_in_df(edited_divs, ["div_per_share", "shares_eligible", "tax", "net_dividend"])
...
with tab4:
    ...
    edited_overrides = utils.process_math_in_df(edited_overrides, ["Free (EUR)", "Bound (EUR)"])
