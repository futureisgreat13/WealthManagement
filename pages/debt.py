...
with tab_val:
    ...
    if active_debt:
        ...
        for yr in val_years:
            col_config[str(yr)] = st.column_config.TextColumn(str(yr))
...
with tab_edit:
    ...
    edited = st.data_editor(edit_df, width="stretch", hide_index=True, num_rows="dynamic",
        column_config={
            ...
            "original_amount_eur": st.column_config.TextColumn("original_amount_eur"),
            "outstanding_balance_eur": st.column_config.TextColumn("outstanding_balance_eur"),
            "annual_payment_eur": st.column_config.TextColumn("annual_payment_eur"),
        })
